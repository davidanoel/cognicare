      ...
      <div className="relative bg-blue-50">
        <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-xl text-gray-500 max-w-3xl">
            Empowering mental health professionals with AI-driven insights and tools to deliver
            better care.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
            ...
            that enhance their ability to understand, diagnose, and treat their clients effectively.
          </p>
        </div>
      </div>
            ...
            <div className="text-left">
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-gray-500">Streamline documentation and record-keeping</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0">
                    <svg
                ...
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-gray-500">Maintain compliance with industry standards</p>
                </li>
              </ul>
            </div>
          </div>
